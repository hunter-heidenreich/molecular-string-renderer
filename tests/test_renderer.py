...
class TestMolecularRenderer:
    ...
    def test_initialization_with_invalid_config(self):
        ...
        with patch.object(RenderConfig, 'model_dump', side_effect=ValueError("Invalid config")):
    ...
    def test_render_success(self, mock_validate_path, mock_validate_format, 
                           mock_validate_string, mock_get_renderer, mock_get_parser):
    ...
    @patch('molecular_string_renderer.renderer.validate_format_type')
    @patch('molecular_string_renderer.renderer.validate_output_path')
    def test_render_parsing_failure(self, mock_validate_path, mock_validate_format,
                                   mock_validate_string, mock_get_parser):
    ...
    @patch('molecular_string_renderer.renderer.validate_format_type')
    @patch('molecular_string_renderer.renderer.validate_output_path')
    def test_render_rendering_failure(self, mock_validate_path, mock_validate_format,
                                     mock_validate_string, mock_get_renderer, mock_get_parser):
    ...
    @patch('molecular_string_renderer.renderer.validate_format_type')
    @patch('molecular_string_renderer.renderer.validate_output_path')
    def test_render_with_output_save(self, mock_validate_path, mock_validate_format,
                                    mock_validate_string, mock_get_output_handler,
                                    mock_get_renderer, mock_get_parser):
    ...
    @patch('molecular_string_renderer.renderer.validate_format_type')
    @patch('molecular_string_renderer.renderer.validate_output_path')
    def test_render_output_save_failure(self, mock_validate_path, mock_validate_format,
                                       mock_validate_string, mock_get_output_handler,
                                       mock_get_renderer, mock_get_parser):
    ...
    def test_render_grid_success(self, mock_grid_renderer_class, mock_validate_path,
                                mock_validate_format, mock_validate_grid, mock_parse_list):
    ...
    @patch('molecular_string_renderer.renderer.validate_format_type')
    @patch('molecular_string_renderer.renderer.validate_output_path')
    def test_render_grid_no_valid_molecules(self, mock_validate_path, mock_validate_format,
                                           mock_validate_grid, mock_parse_list):
    ...
    @patch('molecular_string_renderer.renderer.validate_format_type')
    @patch('molecular_string_renderer.renderer.validate_output_path')
    def test_render_grid_invalid_legends(self, mock_validate_path, mock_validate_format,
                                        mock_validate_grid, mock_parse_list):
    ...
    def test_caching_behavior(self):
        ...
        with patch('molecular_string_renderer.renderer.get_parser') as mock_get_parser, \
             patch('molecular_string_renderer.renderer.get_renderer') as mock_get_renderer, \
             patch('molecular_string_renderer.renderer.validate_molecular_string'), \
             patch('molecular_string_renderer.renderer.validate_format_type', return_value="smiles"), \
             patch('molecular_string_renderer.renderer.validate_output_path', return_value=None):
    ...
    def test_config_update_with_invalid_config(self):
        ...
        with patch.object(RenderConfig, 'model_dump', side_effect=ValueError("Invalid")):
            with pytest.raises(ConfigurationError, match="Invalid render configuration"):
    ...
    @patch('molecular_string_renderer.renderer.validate_format_type')
    @patch('molecular_string_renderer.renderer.validate_output_path')
    def test_parser_exception_handling(self, mock_validate_path, mock_validate_format,
                                      mock_validate_string, mock_get_parser):
    ...
    @patch('molecular_string_renderer.renderer.validate_format_type')
    @patch('molecular_string_renderer.renderer.validate_output_path')
    def test_renderer_exception_handling(self, mock_validate_path, mock_validate_format,
                                        mock_validate_string, mock_get_renderer, mock_get_parser):
...
class TestMolecularRendererIntegration:
    ...
    @patch('molecular_string_renderer.renderer.validate_format_type')
    @patch('molecular_string_renderer.renderer.validate_output_path')
    def test_render_with_svg_output(self, mock_validate_path, mock_validate_format,
                                   mock_validate_string, mock_get_output_handler,
                                   mock_get_renderer, mock_get_parser):
        ...
        renderer = MolecularRenderer()
        result = renderer.render("CCO", "smiles", output_format="svg", output_path="test.svg")
    ...
    @patch('molecular_string_renderer.renderer.validate_format_type')
    @patch('molecular_string_renderer.renderer.validate_output_path')
    def test_render_with_non_svg_output(self, mock_validate_path, mock_validate_format,
                                       mock_validate_string, mock_get_output_handler,
                                       mock_get_renderer, mock_get_parser):
        ...
        renderer = MolecularRenderer()
        result = renderer.render("CCO", "smiles", output_format="png", output_path="test.png")
    ...
    def test_render_grid_with_parsing_errors(self, mock_format_errors, mock_validate_path,
                                            mock_validate_format, mock_validate_grid, mock_parse_list):
        ...
        with pytest.raises(ParsingError, match="No valid molecules could be parsed. Errors: Detailed error info"):
            renderer.render_grid(["invalid1", "invalid2"], "smiles")
    ...
    @patch('molecular_string_renderer.renderer.validate_output_path')
    @patch('molecular_string_renderer.renderers.MoleculeGridRenderer')
    def test_render_grid_with_legends_filtering(self, mock_grid_renderer_class, mock_validate_path,
                                               mock_validate_format, mock_validate_grid, mock_parse_list):
    ...
    @patch('molecular_string_renderer.renderer.validate_output_path')
    @patch('molecular_string_renderer.renderers.MoleculeGridRenderer')
    def test_render_grid_legend_count_mismatch_warning(self, mock_grid_renderer_class, mock_validate_path,
                                                      mock_validate_format, mock_validate_grid, mock_parse_list):
        ...
        with patch('molecular_string_renderer.renderer.logger') as mock_logger:
            result = renderer.render_grid(["CCO", "CCC", "invalid"], "smiles", legends=legends)
            ...
            mock_grid_renderer.render_grid.assert_called_once_with(mock_mols, ["Legend 0", "Legend 2"])
    ...
    @patch('molecular_string_renderer.renderer.validate_output_path')
    @patch('molecular_string_renderer.renderers.MoleculeGridRenderer')
    def test_render_grid_renderer_exception_handling(self, mock_grid_renderer_class, mock_validate_path,
                                                     mock_validate_format, mock_validate_grid, mock_parse_list):
    ...
    @patch('molecular_string_renderer.renderers.MoleculeGridRenderer')
    @patch('molecular_string_renderer.renderer.get_output_handler')
    def test_render_grid_output_exception_handling(self, mock_get_output_handler, mock_grid_renderer_class,
                                                   mock_validate_path, mock_validate_format, 
                                                   mock_validate_grid, mock_parse_list):
    ...
    def test_update_config_parser_invalid(self):
        ...
        with patch.object(ParserConfig, 'model_dump', side_effect=ValueError("Invalid parser config")):
            with pytest.raises(ConfigurationError, match="Invalid parser configuration"):
    ...
    def test_update_config_output_invalid(self):
        ...
        with patch.object(OutputConfig, 'model_dump', side_effect=ValueError("Invalid output config")):
            with pytest.raises(ConfigurationError, match="Invalid output configuration"):
    ...
    @patch('molecular_string_renderer.renderer.validate_output_path')
    @patch('molecular_string_renderer.renderers.MoleculeGridRenderer')
    def test_render_grid_legend_filter_mismatch_warning(self, mock_grid_renderer_class, mock_validate_path,
                                                       mock_validate_format, mock_validate_grid, mock_parse_list):
        ...
        with patch('molecular_string_renderer.renderer.logger') as mock_logger:
            result = renderer.render_grid(["CCO", "CCC", "DDD"], "smiles", legends=legends)
